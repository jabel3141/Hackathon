...
class PurpleFinder:
    ...
    def __init__(self):
        ...
        self.__rgb_threshold_red = [60, 210]
        self.__rgb_threshold_green = [69, 109]
        self.__rgb_threshold_blue = [129, 199]
        ...
        self.__filter_contours_min_area = 100
        self.__filter_contours_min_perimeter = 0
        self.__filter_contours_min_width = 0
        self.__filter_contours_max_width = 1000
        self.__filter_contours_min_height = 0
        self.__filter_contours_max_height = 1000
        self.__filter_contours_solidity = [19, 100.0]
    ...
    def __filter_contours(source0,input_contours, min_area, min_perimeter, min_width, max_width,
        ...
        for contour in input_contours:
            ...
            cv2.putText(source0, " Purple Ball x ="+str(cX)+", y ="+str(cY), (cX - 20, cY - 20),
