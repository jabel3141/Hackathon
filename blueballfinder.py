...
class BlueFinder:
    ...
    def __init__(self):
        ...
        self.__filter_contours_solidity = [63, 100.0]
    ...
    def process(self, source0):
        ...
        """
        lower_blue = np.array([198, 100, 47.5])
        upper_blue = np.array([232,100,19])

        # Step RGB_Threshold0:
        self.__rgb_threshold_input = source0
        hsv = cv2.cvtColor(self.__rgb_threshold_input, cv2.COLOR_BGR2HSV)
        mask = cv2.inRange(hsv,lower_blue,upper_blue)

        (self.rgb_threshold_output) = cv2.bitwise_and(self.__rgb_threshold_input, self.__rgb_threshold_input, mask = mask)
