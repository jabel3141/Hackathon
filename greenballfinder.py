...
class GreenFinder:
    ...
    def __init__(self):
        ...
        self.__rgb_threshold_red = [0, 95]
        self.__rgb_threshold_green = [115, 255]
        self.__rgb_threshold_blue = [117, 155]
    ...
    def __filter_contours(source0,input_contours, min_area, min_perimeter, min_width, max_width,
        ...
        for contour in input_contours:
            ...
            cv2.putText(source0, " Green Ball x ="+str(cX)+", y ="+str(cY), (cX - 20, cY - 20),
