...
class DarkRedFinder:
    ...
    def __init__(self):
        ...
        self.__rgb_threshold_red = [149, 255.0]
        self.__rgb_threshold_green = [0, 123]
        self.__rgb_threshold_blue = [60, 255]
        ...
        self.__filter_contours_solidity = [35, 100.0]
    ...
    def __filter_contours(source0,input_contours, min_area, min_perimeter, min_width, max_width,
        ...
        for contour in input_contours:
            ...
            cv2.putText(source0, " Brown Ball x ="+str(cX)+", y ="+str(cY), (cX - 20, cY - 20),
